...
*/
	...
	/**
		...
		1. For the "Range of Uikit2 components to use" setting, select "Load all Uikit2 components" option.
		2. For the "Use Uikit3 via CDN" setting, RESET (Uncheck) the checkbox.
