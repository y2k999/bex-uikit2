	...
	function beans_post_search_title()
	{
		...
		*/
		beans_open_markup_e('beans_search_title','h1',array('class' => 'uk-article-title'));
			...
			printf('%1$s%2$s',beans_output('beans_search_title_text',esc_html__('Search results for: ','bex-uikit2')),get_search_query());
	...
	function beans_post_more_link()
	{
		...
		*/
		$output = beans_open_markup('beans_post_more_link','a',array(
			...
			$output .= beans_output('beans_post_more_link_text',esc_html__('Continue reading','bex-uikit2'));
	...
	function beans_post_content_navigation()
	{
		...
		*/
		echo wp_link_pages(array(
			'before' => beans_open_markup('beans_post_content_navigation','p',array('class' => 'uk-text-bold')) . beans_output('beans_post_content_navigation_text',__('Pages:','bex-uikit2')),
	...
	function beans_post_navigation()
	{
		...
		*/
		beans_open_markup_e('beans_post_navigation_nav_container','nav',array(
			...
			'aria-label' => __('Pagination Navigation','bex-uikit2'),
		));
			...
			if($previous){
				beans_open_markup_e('beans_post_navigation_item[_previous]','li',array('class' => 'uk-pagination-previous'));
					...
					echo get_previous_post_link('%link',
						beans_output('beans_previous_text[_post_navigation_item]',__('Previous Page','bex-uikit2'))
					);
			...
			if($next){
				beans_open_markup_e('beans_post_navigation_item[_next]','li',array('class' => 'uk-pagination-next'));
					...
					echo get_next_post_link('%link',
						beans_output('beans_next_text[_post_navigation_item]',__('Next Page','bex-uikit2'))
					);
	...
	function beans_posts_pagination()
	{
		...
		*/
		beans_open_markup_e('beans_posts_pagination_nav_container','nav',	array(
			'role' => 'navigation',
			/* Attributes are automatically escaped. */
			'aria-label' => __('Posts Pagination Navigation','bex-uikit2'),
		));
			...
			if(get_previous_posts_link()){
				beans_open_markup_e('beans_posts_pagination_item[_previous]','li');
					beans_open_markup_e('beans_previous_link[_posts_pagination]','a',array(
						...
						beans_output_e('beans_previous_text[_posts_pagination]',esc_html__('Previous Page','bex-uikit2'));
			...
			if(get_next_posts_link()){
				beans_open_markup_e('beans_posts_pagination_item[_next]','li');
					beans_open_markup_e('beans_next_link[_posts_pagination]','a',array(
						...
						beans_output_e('beans_next_text[_posts_pagination]',esc_html__('Next Page','bex-uikit2'));
		...
		beans_open_markup_e('beans_post','article',array('class' => 'tm-no-article uk-article' . (current_theme_supports('beans-default-styling') ? ' uk-panel-box' : NULL)));
			beans_open_markup_e('beans_post_header','header');
				beans_open_markup_e('beans_post_title', 'h1',array('class' => 'uk-article-title'));
					beans_output_e('beans_no_post_article_title_text',esc_html__('Whoops, no result found!','bex-uikit2'));
			...
			beans_open_markup_e('beans_post_body','div');
				beans_open_markup_e('beans_post_content','div',array('class' => 'tm-article-content'));
					beans_open_markup_e('beans_no_post_article_content','p',array('class' => 'uk-alert uk-alert-warning'));
						beans_output_e('beans_no_post_article_content_text',esc_html__('It looks like nothing was found at this location. Maybe try a search?','bex-uikit2'));
	...
	function beans_post_password_form()
	{
		...
		*/
		...
		$output = beans_open_markup('beans_password_form_notice','p',array('class' => 'uk-alert uk-alert-warning'));
			$output .= beans_output('beans_password_form_notice_text',esc_html__('This post is protected. To view it, enter the password below!','bex-uikit2'));
		...
		$output .= beans_open_markup('beans_password_form','form',array(
			...
			$output .= beans_selfclose_markup('beans_password_form_input','input',array(
				...
				'type' => 'password',
				/* Attributes are automatically escaped. */
				'placeholder' => apply_filters('beans_password_form_input_placeholder',__('Password','bex-uikit2')),
				'name' => 'post_password',
			));
			$output .= beans_selfclose_markup('beans_password_form_submit','input',array(
				...
				'name'  => 'submit',
				/* Attributes are automatically escaped. */
				'value' => apply_filters('beans_password_form_submit_text',__('Submit','bex-uikit2')),
			));
