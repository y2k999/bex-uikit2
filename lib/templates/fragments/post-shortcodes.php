...
*/
	...
	*/
	function beans_post_meta_date_shortcode()
	{
		...
		*/
		beans_output_e('beans_post_meta_date_prefix',esc_html__('Posted on ','bex-uikit2'));
	...
	*/
	function beans_post_meta_author_shortcode()
	{
		 ...
		 * 	https://www.getbeans.io/code-reference/functions/beans_close_markup_e/
		*/
		beans_output_e('beans_post_meta_author_prefix',esc_html__('By ','bex-uikit2'));
	...
	function beans_post_meta_comments_shortcode()
	{
		...
		*/
		if($comments_number < 1){
			$comment_text = beans_output('beans_post_meta_empty_comment_text',esc_html__('Leave a comment','bex-uikit2'));
		}
		elseif(1 === $comments_number){
			$comment_text = beans_output('beans_post_meta_comments_text_singular',esc_html__('1 comment','bex-uikit2'));
		}
		else{
			/* translators: %s: Number of comments. Plural. */
			$comment_text = beans_output('beans_post_meta_comments_text_plural',esc_html__('%s comments','bex-uikit2'));
		}
	...
	*/
	function beans_post_meta_tags_shortcode()
	{
		...
		*/
		...
		printf('%1$s%2$s',beans_output('beans_post_meta_tags_prefix',esc_html__('Tagged with: ','bex-uikit2')),$tags);
	...
	*/
	function beans_post_meta_categories_shortcode()
	{
		...
		*/
		...
		printf('%1$s%2$s',beans_output('beans_post_meta_categories_prefix',esc_html__('Filed under: ','bex-uikit2')),$categories);
