	...
	*/
	...
	function beans_breadcrumb()
	{
		...
		*/
		...
		$breadcrumbs = array();
		$breadcrumbs[home_url()] = __('Home','bex-uikit2');
		...
		*/
		...
		elseif(is_search()){
			...
			*/
			$breadcrumbs[] = __('Results:','bex-uikit2') . ' ' . get_search_query();
		}
		elseif(is_author()){
			/**
			 * @since 1.0.1
			...
			*/
			...
			$breadcrumbs[] = __('Author Archives:','bex-uikit2') . ' ' . $author->display_name;
		}
		elseif(is_tag()){
			/**
			 * @since 1.0.1
			...
			*/
			$breadcrumbs[] = __('Tag Archives:','bex-uikit2') . ' ' . single_tag_title('',FALSE);
		}
		elseif(is_date()){
			/**
			 * @since 1.0.1
			...
			*/
			$breadcrumbs[] = __('Archives:','bex-uikit2') . ' ' . get_the_time('F Y');
		}
		elseif(is_404()){
			/**
			 * @since 1.0.1
