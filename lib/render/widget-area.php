		...
		*/
		if(Beans_Extension\__utility_get_beans_admin_settings('stop_widget')){
			...
			register_sidebar(array(
				'name' => __('[WP] Sidebar Primary','bex-uikit2'),
				'id' => 'sidebar_primary',
			));
			register_sidebar(array(
				'name' => __('[WP] Sidebar Secondary','bex-uikit2'),
				'id' => 'sidebar_secondary',
			));
			if(current_theme_supports('offcanvas-menu')){
				register_sidebar(array(
					'name' => __('[WP] Off-Canvas Menu','bex-uikit2'),
					'id' => 'offcanvas_menu',
			...
			beans_register_widget_area(array(
				'name' => __('Sidebar Primary','bex-uikit2'),
				'id' => 'sidebar_primary',
			));
			beans_register_widget_area(array(
				'name' => __('Sidebar Secondary','bex-uikit2'),
				'id' => 'sidebar_secondary',
			));
			...
			*/
			if(current_theme_supports('offcanvas-menu')){
				beans_register_widget_area(array(
					'name' => __('Off-Canvas Menu','bex-uikit2'),
					'id' => 'offcanvas_menu',
					'beans_type' => 'offcanvas',
				));
			}
